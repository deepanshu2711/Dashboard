    ...
    return ( 
        <div className="bg-gray-100 p-3 rounded-lg">
            <div className="bg-white rounded-lg p-2 h-[200px] w-full ">
                {/* <p className="text-[14px] font-semibold">Cloud Accounts</p> */}
                <div className="flex items-center justify-center w-full h-full">
                    <div className=" cursor-pointer group gap-4 p-1 px-4 rounded-md hover:border-gray-900 border-gray-300 border flex items-center">
